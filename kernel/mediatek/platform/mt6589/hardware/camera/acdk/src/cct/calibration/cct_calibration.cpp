    ...
    */
    ...
    for (MINT32 i4Exp = a_i4ExpStart; i4Exp <= a_i4ExpEnd; i4Exp += a_i4ExpInterval)
    {
        ...
        */
        ...
        capInfo.u4ExposureMode = a_i4ExpMode;
        capInfo.u4Eposuretime = i4Exp;
        capInfo.u4AfeGain = a_i4Gain;
		capInfo.u4IspGain = a_i4Gain;

        ACDK_LOGD("[u4Eposuretime] Exp = %d\n", capInfo.u4Eposuretime);
    ...
    */
    ...
    for (MINT32 i4Gain = a_i4GainStart; i4Gain <= a_i4GainEnd; i4Gain += a_i4GainInterval)
    {
        ...
        */
        ...
        capInfo.u4Eposuretime = a_i4ExpTime;
        capInfo.u4AfeGain = i4Gain;
    ...
    */
    ...
    for (MINT32 i4GainTableIndex = 0; i4GainTableIndex < a_i4GainTableSize; i4GainTableIndex ++)
    {
        ...
        */
        ...
        capInfo.u4Eposuretime = a_i4ExpTime;
        capInfo.u4AfeGain = a_pi4GainTable[i4GainTableIndex];
		capInfo.u4IspGain = a_pi4GainTable[i4GainTableIndex];
                                     ...
                                     ACDK_CDVT_SENSOR_CALIBRATION_OUTPUT_T *prSensorCalibrationOutput)
{
    ...
    */
    ...
    capInfo.u4Eposuretime = i4DefaultExpTInUS;
    capInfo.u4AfeGain = i4Gain;
	capInfo.u4IspGain = i4Gain;
    ...
    */
    ...
    capInfo.u4Eposuretime = i4TargetExpTInUs_LA;
    capInfo.u4AfeGain = i4Gain;
	capInfo.u4IspGain = i4Gain;
    ...
    */
    ...
    capInfo.u4Eposuretime = i4TargetExpTInUs_UA;
    capInfo.u4AfeGain = i4Gain;
    capInfo.u4IspGain = i4Gain;
...
//   MINT32 u4CaliMode = 0;
   ...
   mrRet = m_pAcdkBaseObj->sendcommand(ACDK_CCT_OP_AE_GET_ENABLE_INFO,
    ...
    ACDK_LOGE("[AcdkCalibration::mrCalLenShading]"
     ...
     {
            ACDK_LOGE(" AcdkCalibration::Shading Calibration Error! Exposure time > 2 second\n");
            goto Exit;
      }
...
//            ACDK_LOGE("[%s] Get RAW Image Fail \n", __FUNCTION__);
//            ACDK_LOGE(" Get Preview Image Buffer Addr Fail\n");
//            ACDK_LOGE(" Exit to Lens Shading calibration procedure\n");
//            goto Exit;
//        }
...
//                vCapCb);
    ...
    if ((UINT32)a_i4PreCap == VIDEO_TEST)    //Video Test
    {
        ...
        m_u4CapMode = 1; //"0" will do 1/2 subsampe of image
//        mrRet = m_pAcdkBaseObj->takePicture(VIDEO_MODE,
//                PURE_RAW8_TYPE, //webber check
//                vCapCb);
        if(takePicture(VIDEO_MODE, PURE_RAW8_TYPE) != S_ACDK_CALIBRATION_OK)
        {
            ACDK_LOGE("[%s] Get RAW Image Fail \n", __FUNCTION__);
            ACDK_LOGE(" Get Video Image Buffer Addr Fail\n");
            ACDK_LOGE(" Exit to Lens Shading calibration procedure\n");
            goto Exit;
        }
