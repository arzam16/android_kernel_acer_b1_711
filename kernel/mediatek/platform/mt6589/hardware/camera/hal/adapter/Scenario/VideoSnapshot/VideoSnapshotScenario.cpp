...
transMainThumb(MBOOL en)
{
    ...
    if(en)
    {
        ...
        Config.ImageIn.Format = eImgFmt_UYVY;
...
encodeJpgMain(void)
{
    ...
    saveData(
        ...
        mJpgInfo[MemType_JpgMain].bitStrSize,
        "/sdcard/vss_main.jpg");
    //
    EXIT:
    FUNCTION_OUT;
...
encodeJpgThumb(void)
{
    ...
    saveData(
        ...
        mJpgInfo[MemType_JpgThumb].bitStrSize,
...
integrateJpg(void)
{
    ...
    MY_LOGD("JPG bitStrSize:Add exif(%d)",mJpgInfo[JpgType_Img].bitStrSize);
    //
    if(mIsThumb)
    {
        memcpy(
        ...
        MY_LOGD("JPG bitStrSize:Add Thumbnail(%d)",mJpgInfo[JpgType_Img].bitStrSize);
    }
    //
    memcpy(
        (MUINT8*)(mIMemBufInfo[MemType_Jpg].virtAddr+mJpgInfo[JpgType_Img].bitStrSize),
    ...
    MY_LOGD("JPG bitStrSize(%d):Add Main",mJpgInfo[JpgType_Img].bitStrSize);
    //
    saveData(
