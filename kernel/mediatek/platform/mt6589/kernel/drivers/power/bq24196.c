...
extern int g_pmic_init_for_bq24196; //add this line 
...
kal_uint32 bq24196_get_chg_config(void)
{
	kal_uint32 ret=0;
	kal_uint8 val=0;

	ret=bq24196_read_interface(     (kal_uint8)(bq24196_CON1),
					(&val),
					(kal_uint8)(CON1_CHG_CONFIG_MASK),
					(kal_uint8)(CON1_CHG_CONFIG_SHIFT)
					);
...
void bq24196_set_ichg_20(kal_uint32 val)
{
    kal_uint32 ret=0;
...
{             
    ...
    //---------------------
    g_pmic_init_for_bq24196 = 1; //add this line 
