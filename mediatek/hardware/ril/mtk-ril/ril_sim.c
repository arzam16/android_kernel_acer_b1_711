...
static void setPINretryCount(SimPinCount *result,  RILId rid)
{
    ...
    int  forceToUpdate = 0;
    const char *propPin1 = PROPERTY_RIL_SIM_PIN1;
    const char *propPin2 = PROPERTY_RIL_SIM_PIN2;
    const char *propPuk1 = PROPERTY_RIL_SIM_PUK1;
    const char *propPuk2 = PROPERTY_RIL_SIM_PUK2;

    if (getMappingSIMByCurrentMode(rid) == GEMINI_SIM_2) {
        propPin1 = PROPERTY_RIL_SIM2_PIN1;
        propPin2 = PROPERTY_RIL_SIM2_PIN2;
        propPuk1 = PROPERTY_RIL_SIM2_PUK1;
        propPuk2 = PROPERTY_RIL_SIM2_PUK2;
    }
...
void requestPhbStatus(RILId rid)
{
    ...
    if (RIL_E_SUCCESS == ret)
        upadteSystemPropertyByCurrentMode(rid, PROPERTY_RIL_PHB_READY, PROPERTY_RIL_PHB_READY_2, "true");
    else
        upadteSystemPropertyByCurrentMode(rid, PROPERTY_RIL_PHB_READY, PROPERTY_RIL_PHB_READY_2, "false");
    return;
error:
...
void rilSwitchSimProperty() {
    ...
    switchProperty(PROPERTY_RIL_SIM_PIN1, PROPERTY_RIL_SIM_PIN2, 128);
    switchProperty(PROPERTY_RIL_SIM_PUK1, PROPERTY_RIL_SIM_PUK2, 128);
    switchProperty(PROPERTY_RIL_SIM2_PIN1, PROPERTY_RIL_SIM2_PIN2, 128);
    switchProperty(PROPERTY_RIL_SIM2_PUK1, PROPERTY_RIL_SIM2_PUK2, 128);
}
...
void resetSIMProperties(RILId rid) {
    upadteSystemPropertyByCurrentMode(rid, PROPERTY_RIL_SIM_PIN1, PROPERTY_RIL_SIM_PIN2, NULL);
    upadteSystemPropertyByCurrentMode(rid, PROPERTY_RIL_SIM_PUK1, PROPERTY_RIL_SIM_PUK2, NULL);
    upadteSystemPropertyByCurrentMode(rid, PROPERTY_RIL_SIM2_PIN1, PROPERTY_RIL_SIM2_PIN2, NULL);
    upadteSystemPropertyByCurrentMode(rid, PROPERTY_RIL_SIM2_PUK1, PROPERTY_RIL_SIM2_PUK2, NULL);
    upadteSystemPropertyByCurrentMode(rid, PROPERTY_RIL_ECCLIST, PROPERTY_RIL_ECCLIST_2, NULL);
    upadteSystemPropertyByCurrentMode(rid, PROPERTY_RIL_UICC_TYPE, PROPERTY_RIL_UICC2_TYPE, NULL);
    upadteSystemPropertyByCurrentMode(rid, PROPERTY_RIL_PHB_READY, PROPERTY_RIL_PHB_READY_2, NULL);
    upadteSystemPropertyByCurrentMode(rid, PROPERTY_RIL_TESTSIM, PROPERTY_RIL_TESTSIM_2, NULL);
    upadteSystemPropertyByCurrentMode(rid, PROPERTY_ICCID_SIM1, PROPERTY_ICCID_SIM2, NULL);
}
