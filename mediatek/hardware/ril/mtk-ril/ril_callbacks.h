...
#define PROPERTY_ICCID_SIM1 "ril.iccid.sim1"
#define PROPERTY_ICCID_SIM2 "ril.iccid.sim2"
#define PROPERTY_FLIGHT_MODE_POWER_OFF_MD "ril.flightmode.poweroffMD"
#define PROPERTY_TELEPHONY_MODE "ril.telephony.mode"
#define PROPERTY_FIRST_MD "ril.first.md"
...
extern int isFlightModePowerOffModem();
