	...
	{      spin_lock(&ov7675_yuv_drv_lock);
	   ...
	   if(OV7675_Sensor_Driver.MPEG4_encode_mode == KAL_TRUE)
		{		
		   ...
		   printk("OV7675 night mode ture camera video preview\r\n");
/*
...
*/
	   ...
	   {
	          printk("OV7675 night mode ture camera still preview\r\n");
			  OV7675_Set_Dummy(0,0); 
			//  OV7675_write_cmos_sensor(0x3B,(temp&0x1F)|0xE0); //1/8 normal framerate   
			  ...
			  OV7675_write_cmos_sensor(0xCF,0x8C);//gaiyang add for 1/8 normal framerate
	...
	else
	{
	    ...
	    if(OV7675_Sensor_Driver.MPEG4_encode_mode == KAL_TRUE)
	    {
			...
			{	
			   ...
			   OV7675_write_cmos_sensor(0xCF,0x84); //gaiyang add for 1/2 normal framerate
...
OV7675_write_cmos_sensor(0xc1, 0x7f);
OV7675_write_cmos_sensor(0x11, 0x80);
mDELAY(2);
OV7675_write_cmos_sensor(0x3a, 0x0c);
OV7675_write_cmos_sensor(0x3d, 0xc0);
OV7675_write_cmos_sensor(0x12, 0x00);
OV7675_write_cmos_sensor(0x15, 0x40);
OV7675_write_cmos_sensor(0x17, 0x13);
OV7675_write_cmos_sensor(0x18, 0x01);
OV7675_write_cmos_sensor(0x32, 0xbf);
OV7675_write_cmos_sensor(0x19, 0x02);
OV7675_write_cmos_sensor(0x1a, 0x7a);
OV7675_write_cmos_sensor(0x03, 0x0a);
OV7675_write_cmos_sensor(0x0c, 0x00);
OV7675_write_cmos_sensor(0x3e, 0x00);
OV7675_write_cmos_sensor(0x70, 0x3a);
OV7675_write_cmos_sensor(0x71, 0x35);
//OV7675_write_cmos_sensor(0x71, 0xB5);	//ENABLE TEST PARTTERN
OV7675_write_cmos_sensor(0x72, 0x11);
OV7675_write_cmos_sensor(0x73, 0xf0);
OV7675_write_cmos_sensor(0xa2, 0x02);
OV7675_write_cmos_sensor(0x13, 0xe0);
OV7675_write_cmos_sensor(0x00, 0x00);
OV7675_write_cmos_sensor(0x10, 0x00);
OV7675_write_cmos_sensor(0xa5, 0x02);
OV7675_write_cmos_sensor(0xab, 0x02);
...
OV7675_write_cmos_sensor(0x0e, 0x61);
OV7675_write_cmos_sensor(0x0f, 0x4b);
OV7675_write_cmos_sensor(0x16, 0x02);
OV7675_write_cmos_sensor(0x1e, 0x07);
OV7675_write_cmos_sensor(0x21, 0x02);
OV7675_write_cmos_sensor(0x22, 0x91);
OV7675_write_cmos_sensor(0x29, 0x07);
OV7675_write_cmos_sensor(0x33, 0x0b);
OV7675_write_cmos_sensor(0x35, 0x0b);
OV7675_write_cmos_sensor(0x37, 0x1d);
OV7675_write_cmos_sensor(0x38, 0x71);
OV7675_write_cmos_sensor(0x39, 0x2a);
OV7675_write_cmos_sensor(0x3c, 0x78);
OV7675_write_cmos_sensor(0x4d, 0x40);
OV7675_write_cmos_sensor(0x4e, 0x20);
OV7675_write_cmos_sensor(0x69, 0x00);
OV7675_write_cmos_sensor(0x6b, 0x0a);
OV7675_write_cmos_sensor(0x74, 0x10);
OV7675_write_cmos_sensor(0x8d, 0x4f);
...
OV7675_write_cmos_sensor(0xb0, 0x84);
OV7675_write_cmos_sensor(0xb1, 0x0c);
...
OV7675_write_cmos_sensor(0x3f, 0x00);
OV7675_write_cmos_sensor(0x4c, 0x00);
OV7675_write_cmos_sensor(0x3d, 0xc2);
...
OV7675_write_cmos_sensor(0x2a, 0x10);
OV7675_write_cmos_sensor(0x2b, 0xc2);
//OV7675_write_cmos_sensor(0x15, 0x00);
OV7675_write_cmos_sensor(0x15, 0x42);
OV7675_write_cmos_sensor(0x3a, 0x0c);
OV7675_write_cmos_sensor(0x19, 0x03);
OV7675_write_cmos_sensor(0x1a, 0x7b);
OV7675_write_cmos_sensor(0x2a, 0x00);
OV7675_write_cmos_sensor(0x2b, 0x00);
OV7675_write_cmos_sensor(0x18, 0x01);
//CMX
OV7675_write_cmos_sensor(0x4f, 0x87);
OV7675_write_cmos_sensor(0x50, 0x58);
OV7675_write_cmos_sensor(0x51, 0x2e);
OV7675_write_cmos_sensor(0x52, 0x15);
OV7675_write_cmos_sensor(0x53, 0x7c);
OV7675_write_cmos_sensor(0x54, 0x91);
OV7675_write_cmos_sensor(0x58, 0x1e);
//sharpness
OV7675_write_cmos_sensor(0x41, 0x38);
OV7675_write_cmos_sensor(0x75, 0x07);
...
OV7675_write_cmos_sensor(0x45, 0x26);
OV7675_write_cmos_sensor(0x46, 0x5f);
OV7675_write_cmos_sensor(0x47, 0x2e);
OV7675_write_cmos_sensor(0x48, 0x42);
OV7675_write_cmos_sensor(0x59, 0xb1);
OV7675_write_cmos_sensor(0x5a, 0xb5);
OV7675_write_cmos_sensor(0x5b, 0xdd);
OV7675_write_cmos_sensor(0x5c, 0x7b);
OV7675_write_cmos_sensor(0x5d, 0x57);
OV7675_write_cmos_sensor(0x5e, 0x14);
OV7675_write_cmos_sensor(0x6a, 0x40);
OV7675_write_cmos_sensor(0x6c, 0x0e);
OV7675_write_cmos_sensor(0x6d, 0x65);
OV7675_write_cmos_sensor(0x6e, 0x11);
OV7675_write_cmos_sensor(0x6f, 0x9e);
OV7675_write_cmos_sensor(0x09, 0x00);
//AE
OV7675_write_cmos_sensor(0x24, 0x4e);
OV7675_write_cmos_sensor(0x25, 0x48);
OV7675_write_cmos_sensor(0x26, 0x81);
//LensC
OV7675_write_cmos_sensor(0x66, 0x05);
OV7675_write_cmos_sensor(0x62, 0x38);
OV7675_write_cmos_sensor(0x63, 0xa0);
OV7675_write_cmos_sensor(0x65, 0x07);
OV7675_write_cmos_sensor(0x64, 0x17);
OV7675_write_cmos_sensor(0x94, 0x15);
OV7675_write_cmos_sensor(0x95, 0x1c);
//Night, 0xmode, 0x-, 0x30~10fps
OV7675_write_cmos_sensor(0xcf, 0x84);
OV7675_write_cmos_sensor(0x3b, 0xd2);
//Ceil, 0xgain
OV7675_write_cmos_sensor(0x14, 0x28);
OV7675_write_cmos_sensor(0xa4, 0x89);
//AE, 0xwindow, 0x-, 0x1/4
OV7675_write_cmos_sensor(0x0d, 0x70);
OV7675_write_cmos_sensor(0x42, 0xc0);
//Gamma, 0x-, 0xfinal
OV7675_write_cmos_sensor(0x7a, 0x0f);
OV7675_write_cmos_sensor(0x7b, 0x03);
OV7675_write_cmos_sensor(0x7c, 0x08);
OV7675_write_cmos_sensor(0x7d, 0x10);
OV7675_write_cmos_sensor(0x7e, 0x50);
OV7675_write_cmos_sensor(0x7f, 0x60);
OV7675_write_cmos_sensor(0x80, 0x6e);
OV7675_write_cmos_sensor(0x81, 0x7b);
OV7675_write_cmos_sensor(0x82, 0x87);
OV7675_write_cmos_sensor(0x83, 0x92);
OV7675_write_cmos_sensor(0x84, 0x9c);
OV7675_write_cmos_sensor(0x85, 0xaf);
OV7675_write_cmos_sensor(0x86, 0xbf);
OV7675_write_cmos_sensor(0x87, 0xd7);
OV7675_write_cmos_sensor(0x88, 0xe8);
OV7675_write_cmos_sensor(0x89, 0xf4);
}
/*****************************************************************************/
...
static BOOL OV7675_set_param_wb(UINT16 para)
{
	...
	printk("[WB] Set WBMode = %d\n", OV7675_Sensor_Driver.u8Wb_value);
...
void OV7675GetExifInfo(UINT32 exifAddr)
{
    SENSOR_EXIF_INFO_STRUCT* pExifInfo = (SENSOR_EXIF_INFO_STRUCT*)exifAddr;
    pExifInfo->FNumber = 28;
    pExifInfo->AEISOSpeed = AE_ISO_100;
    pExifInfo->AWBMode = (OV7675_Sensor_Driver.u8Wb_value == 0)?AWB_MODE_AUTO:OV7675_Sensor_Driver.u8Wb_value;
//    pExifInfo->AWBMode = OV7675_Sensor_Driver.u8Wb_value;
		...
		case SENSOR_FEATURE_SET_VIDEO_MODE:
			...
			break;
              ...
              case SENSOR_FEATURE_GET_EXIF_INFO:
                     OV7675GetExifInfo(*pFeatureData32);
                     break;
		default:
			break;
	}
