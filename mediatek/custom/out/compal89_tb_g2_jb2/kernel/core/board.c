...
//	mt_set_gpio_mode(GPIO_GPS_FRAM_SYNC_MT3332, GPIO_GPS_FRAM_SYNC_MT3332_M_GPS_SYNC);
...
//	mt_set_gpio_mode(GPIO_GPS_FRAM_SYNC_MT3332, GPIO_GPS_FRAM_SYNC_MT3332_M_GPIO);
...
#define MSDC_EMMC_FLAG	  (MSDC_SYS_SUSPEND | MSDC_HIGHSPEED | MSDC_DDR | MSDC_UHS1)
