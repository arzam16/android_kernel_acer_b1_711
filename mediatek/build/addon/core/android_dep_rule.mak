...
ifneq (yes,$(strip $(MTK_DUAL_MIC_SUPPORT)))
  ifeq (yes,$(strip $(MTK_HANDSFREE_DMNR_SUPPORT)))
    $(call dep-err-ona-or-offb, MTK_DUAL_MIC_SUPPORT, MTK_HANDSFREE_DMNR_SUPPORT)
  endif
endif
#############################################################
ifeq (yes, $(strip $(MTK_PRIVATE_SPACE_SHARE_SUPPORT)))
  ifneq (yes, $(strip $(MTK_PRIVATE_SPACE_SUPPORT)))
